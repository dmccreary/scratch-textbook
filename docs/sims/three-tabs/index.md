...
description: "Shows how a Scratch sprite owns its Code, Costumes, and Sounds tabs; buttons switch between an overview of all three and a detailed view of each tab, describing its purpose and key features."
...
<iframe src="main.html" height="415px" width="100%" scrolling="no"></iframe>

[Run the Three Tabs Explained MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://arunbatchu.github.io/scratch-textbook/sims/three-tabs/main.html"
        height="415px"
        width="100%"
        scrolling="no"></iframe>
```
...
1. [The Three Tabs — Chapter 1: Welcome to Scratch](../../chapters/01-welcome-to-scratch/index.md)
2. [Scratch User Interface — Scratch Wiki](https://en.scratch-wiki.info/wiki/Scratch_User_Interface)
