...
description: "Interactive diagram of a five-block Scratch script showing how hat and stack blocks snap together; hover any block to reveal its description via a toggleable checkbox."
...
[Run the Script Anatomy MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
1. [Your First Script — Chapter 1: Welcome to Scratch](../../chapters/01-welcome-to-scratch/index.md)
2. [Hat Block — Scratch Wiki](https://en.scratch-wiki.info/wiki/Hat_Block)
